...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutomaticImport) DeepCopyInto(out *AutomaticImport) {
	*out = *in
	out.VirtualClusters = in.VirtualClusters
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutomaticImport.
func (in *AutomaticImport) DeepCopy() *AutomaticImport {
	if in == nil {
		return nil
	}
	out := new(AutomaticImport)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutomaticImportVirtualClusters) DeepCopyInto(out *AutomaticImportVirtualClusters) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutomaticImportVirtualClusters.
func (in *AutomaticImportVirtualClusters) DeepCopy() *AutomaticImportVirtualClusters {
	if in == nil {
		return nil
	}
	out := new(AutomaticImportVirtualClusters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SpaceCreationTask) DeepCopyInto(out *SpaceCreationTask) {
	*out = *in
	...
	if in.Apps != nil {
		...
		*out = make([]storagev1.AppReference, len(*in))
		copy(*out, *in)
	}
	return
}
...
func (in *SpaceInstanceSpec) DeepCopyInto(out *SpaceInstanceSpec) {
	*out = *in
	...
	if in.ExtraAccessRules != nil {
		...
		*out = make([]storagev1.InstanceAccessRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SpaceInstanceStatus) DeepCopyInto(out *SpaceInstanceStatus) {
	*out = *in
	...
	if in.SpaceObjects != nil {
		...
		*out = new(storagev1.ObjectsStatus)
		(*in).DeepCopyInto(*out)
	}
	if in.Space != nil {
...
func (in *SpaceTemplateDefinition) DeepCopyInto(out *SpaceTemplateDefinition) {
	*out = *in
	...
	if in.Access != nil {
		in, out := &in.Access, &out.Access
		*out = new(storagev1.InstanceAccess)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
func (in *VirtualClusterInstanceSpec) DeepCopyInto(out *VirtualClusterInstanceSpec) {
	*out = *in
	...
	out.ClusterRef = in.ClusterRef
	if in.WorkloadClusterRef != nil {
		in, out := &in.WorkloadClusterRef, &out.WorkloadClusterRef
		*out = new(VirtualClusterClusterRef)
		**out = **in
	}
	if in.ExtraAccessRules != nil {
...
func (in *VirtualClusterInstanceStatus) DeepCopyInto(out *VirtualClusterInstanceStatus) {
	*out = *in
	...
	if in.WorkloadSpaceObjects != nil {
		in, out := &in.WorkloadSpaceObjects, &out.WorkloadSpaceObjects
		*out = new(storagev1.ObjectsStatus)
		(*in).DeepCopyInto(*out)
	}
	if in.VirtualCluster != nil {
...
func (in *VirtualClusterTemplateDefinition) DeepCopyInto(out *VirtualClusterTemplateDefinition) {
	*out = *in
	...
	in.SpaceTemplate.DeepCopyInto(&out.SpaceTemplate)
	if in.WorkloadVirtualClusterTemplateDefinition != nil {
		in, out := &in.WorkloadVirtualClusterTemplateDefinition, &out.WorkloadVirtualClusterTemplateDefinition
		*out = new(WorkloadVirtualClusterTemplateDefinition)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkloadVirtualClusterTemplateDefinition) DeepCopyInto(out *WorkloadVirtualClusterTemplateDefinition) {
	*out = *in
	in.TemplateMetadata.DeepCopyInto(&out.TemplateMetadata)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkloadVirtualClusterTemplateDefinition.
func (in *WorkloadVirtualClusterTemplateDefinition) DeepCopy() *WorkloadVirtualClusterTemplateDefinition {
	if in == nil {
		return nil
	}
	out := new(WorkloadVirtualClusterTemplateDefinition)
