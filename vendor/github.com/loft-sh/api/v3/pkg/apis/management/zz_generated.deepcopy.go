...
func (in *AgentAnalyticsSpec) DeepCopyInto(out *AgentAnalyticsSpec) {
	*out = *in
	if in.InstanceTokenAuth != nil {
		...
		*out = new(server.InstanceTokenAuth)
		**out = **in
	}
	return
}
...
func (in *ClusterAgentConfig) DeepCopyInto(out *ClusterAgentConfig) {
	*out = *in
	...
	in.AnalyticsSpec.DeepCopyInto(&out.AnalyticsSpec)
	return
}
...
func (in *LicenseStatus) DeepCopyInto(out *LicenseStatus) {
	*out = *in
	if in.Buttons != nil {
		...
		*out = make(server.Buttons, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(server.Button)
				**out = **in
			}
		}
	}
