...
type LegacyPlatformConfig struct {
	...
	// +optional
	AutoSleep *LegacyAutoSleep `json:"autoSleep,omitempty" yaml:"autoSleep,omitempty"`
...
type LegacyAutoSleep struct {
	...
	// +optional
	AutoWakeup *LegacyAutoWakeup `json:"autoWakeup,omitempty" yaml:"autoWakeup,omitempty"`
}
