...
import (
	...
	scheme "github.com/loft-sh/agentapi/v3/pkg/client/loft/clientset_generated/clientset/scheme"
...
func (c *features) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.Feature, err error) {
	result = &v1.Feature{}
	err = c.client.Get().
		Resource("features").
		Name(name).
...
func (c *features) List(ctx context.Context, opts metav1.ListOptions) (result *v1.FeatureList, err error) {
...
func (c *features) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *features) Create(ctx context.Context, feature *v1.Feature, opts metav1.CreateOptions) (result *v1.Feature, err error) {
	result = &v1.Feature{}
	err = c.client.Post().
		Resource("features").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *features) Update(ctx context.Context, feature *v1.Feature, opts metav1.UpdateOptions) (result *v1.Feature, err error) {
	result = &v1.Feature{}
	err = c.client.Put().
		Resource("features").
		Name(feature.Name).
...
func (c *features) UpdateStatus(ctx context.Context, feature *v1.Feature, opts metav1.UpdateOptions) (result *v1.Feature, err error) {
	result = &v1.Feature{}
	err = c.client.Put().
		Resource("features").
		Name(feature.Name).
...
func (c *features) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *features) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *features) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.Feature, err error) {
	result = &v1.Feature{}
