...
// -ldflags '-X github.com/loft-sh/image/sysregistries.systemRegistriesConfPath=$your_path'
...
// obtaining images.  You can override this at build time with
// -ldflags '-X github.com/loft-sh/image/sysregistries.systemRegistriesConfDirectoryPath=$your_path'
