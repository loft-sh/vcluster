...
#######################################################
	...
	cobraCmd.Flags().StringVar(&cmd.Cluster, "cluster", "", "[PLATFORM] The vCluster.Pro connected cluster to use")
	cobraCmd.Flags().StringVar(&cmd.Template, "template", "", "[PLATFORM] The vCluster.Pro template to use")
	cobraCmd.Flags().StringVar(&cmd.TemplateVersion, "template-version", "", "[PLATFORM] The vCluster.Pro template version to use")
