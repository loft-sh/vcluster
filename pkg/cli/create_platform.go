...
func CreatePlatform(ctx context.Context, options *CreateOptions, globalFlags *flags.GlobalFlags, virtualClusterName string, log log.Logger) error {
	...
	if useTemplate {
		...
		if virtualClusterInstance == nil {
			...
			virtualClusterInstance, err = createWithoutTemplate(ctx, proClient, options, virtualClusterName, globalFlags.Namespace, log)
			if err != nil {
				return err
			}
		} else {
...
func createWithoutTemplate(ctx context.Context, proClient platform.Client, options *CreateOptions, virtualClusterName, targetNamespace string, log log.Logger) (*managementv1.VirtualClusterInstance, error) {
...
func upgradeWithoutTemplate(ctx context.Context, proClient platform.Client, options *CreateOptions, virtualClusterInstance *managementv1.VirtualClusterInstance, log log.Logger) (*managementv1.VirtualClusterInstance, error) {
	err := validateNoTemplateOptions(options)
	if err != nil {
		return nil, err
	}
...
func shouldCreateWithTemplate(ctx context.Context, proClient platform.Client, options *CreateOptions, virtualClusterInstance *managementv1.VirtualClusterInstance) (bool, error) {
...
func createWithTemplate(ctx context.Context, proClient platform.Client, options *CreateOptions, virtualClusterName string, log log.Logger) (*managementv1.VirtualClusterInstance, error) {
...
func upgradeWithTemplate(ctx context.Context, proClient platform.Client, options *CreateOptions, virtualClusterInstance *managementv1.VirtualClusterInstance, log log.Logger) (*managementv1.VirtualClusterInstance, error) {
	err := validateTemplateOptions(options)
	if err != nil {
		return nil, err
	}
...
func mergeValues(proClient platform.Client, options *CreateOptions, log log.Logger) (string, error) {
	// merge values
...
func toChartOptions(proClient platform.Client, options *CreateOptions, log log.Logger) (*vclusterconfig.ExtraValuesOptions, error) {
