...
// PromptForMissingArgsIfInteractive expects that the number of args, matched the number of argNames, in the order they should appear
...
func PromptForMissingArgsIfInteractive(l log.Logger, args []string, argNames ...string) ([]string, error) {
