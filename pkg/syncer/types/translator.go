...
type MetadataTranslator interface {
	...
	TranslateMetadata(ctx *syncercontext.SyncContext, vObj client.Object) client.Object
	...
	TranslateMetadataUpdate(ctx *syncercontext.SyncContext, vObj client.Object, pObj client.Object) (changed bool, annotations map[string]string, labels map[string]string)
}
