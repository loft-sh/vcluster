...
func (s *fakeFromHostSyncer) CopyHostObjectToVirtual(vObj, pObj client.Object) {
	pMeta := pObj.(*corev1.ConfigMap).DeepCopy().ObjectMeta
	vObj.SetAnnotations(pMeta.GetAnnotations())
	vObj.SetLabels(pMeta.GetLabels())
}
