...
func (c *reconcilerBase) reconcileCompletedRequest(ctx context.Context, configMap *corev1.ConfigMap, requestMetadata snapshot.RequestMetadata) error {
...
func (c *reconcilerBase) reconcileFailedRequest(ctx context.Context, configMap *corev1.ConfigMap, requestMetadata snapshot.RequestMetadata) error {
...
// snapshot/restore request ConfigMap.
func (c *reconcilerBase) reconcileDoneRequest(ctx context.Context, configMap *corev1.ConfigMap, requestMetadata snapshot.RequestMetadata) (retErr error) {
	defer func() {
		if retErr != nil {
			// an error occurred, don't remove the finalizer
			return
	...
	if time.Since(requestMetadata.CreationTimestamp.Time) >= snapshot.DefaultRequestTTL {
