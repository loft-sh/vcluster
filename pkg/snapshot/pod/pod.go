...
func AddPodFlags(fs *pflag.FlagSet, podOptions *Options) {
...
func CreateSnapshotPod(
	...
	newPod := &corev1.Pod{
		...
		Spec: corev1.PodSpec{
			...
			ServiceAccountName:            options.PodSpec.ServiceAccountName,
			AutomountServiceAccountToken:  ptr.To(false),
			TerminationGracePeriodSeconds: ptr.To(int64(1)),
			NodeName:                      options.PodSpec.NodeName,
	...
	// create the pod
	log.Infof("Starting restore pod for vCluster %s/%s...", options.Namespace, options.VCluster)
