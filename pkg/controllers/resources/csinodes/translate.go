...
func (s *csinodeSyncer) translateBackwards(ctx *synccontext.SyncContext, pCSINode *storagev1.CSINode) *storagev1.CSINode {
	return s.TranslateMetadata(ctx, pCSINode).(*storagev1.CSINode)
}

func (s *csinodeSyncer) translateUpdateBackwards(ctx *synccontext.SyncContext, pObj, vObj *storagev1.CSINode) {
