...
func RegisterIndices(ctx *synccontext.RegisterContext) error {
	...
	if ctx.Config.Networking.Advanced.ProxyKubelets.ByIP {
		err := ctx.PhysicalManager.GetFieldIndexer().IndexField(ctx.Context, &corev1.Service{}, constants.IndexByClusterIP, func(object client.Object) []string {
	...
	err := ctx.VirtualManager.GetFieldIndexer().IndexField(ctx.Context, &corev1.Node{}, constants.IndexByHostName, func(rawObj client.Object) []string {
