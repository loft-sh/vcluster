...
// TODO: remove before merge, waiting for api release
replace github.com/loft-sh/api/v4 => /Users/pascalbreuninger/workspace/loft-enterprise/staging/src/github.com/loft-sh/api/v4

// Same replace as loft-enterprise (go.mod) for tailnet control-protocol compatibility.
replace tailscale.com => github.com/loft-sh/tailscale v1.96.4-loft.1
