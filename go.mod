...
replace github.com/loft-sh/agentapi/v4 => ../loft-enterprise/staging/src/github.com/loft-sh/agentapi/v4

replace github.com/loft-sh/loftctl/v4 => ../loft-enterprise/staging/src/github.com/loft-sh/loftctl/v4
