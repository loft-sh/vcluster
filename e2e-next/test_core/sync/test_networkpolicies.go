...
var _ = Describe("NetworkPolicy egress enforcement",
	labels.Core,
	labels.Sync,
	labels.NetworkPolicies,
	// NonDefault: NetworkPolicy enforcement requires a CNI with NetworkPolicy support
	// (e.g. Calico). The standard Kind cluster used in CI does not enforce NetworkPolicies.
	labels.NonDefault,
