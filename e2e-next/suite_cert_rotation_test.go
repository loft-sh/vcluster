...
// watcher rotation with short-lived certs.
...
func suiteShortCertsVCluster() {
	...
	// SingleReplicaWatcherSpec because the watcher test triggers a pod
	// restart which would disrupt the serving cert Consistently check.
