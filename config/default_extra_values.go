...
var K3SVersionMap = map[string]string{
	"1.33": "mirror.gcr.io/rancher/k3s:v1.33.1-k3s1",
	"1.32": "mirror.gcr.io/rancher/k3s:v1.32.1-k3s1",
	"1.31": "mirror.gcr.io/rancher/k3s:v1.31.1-k3s1",
	"1.30": "mirror.gcr.io/rancher/k3s:v1.30.2-k3s1",
}
