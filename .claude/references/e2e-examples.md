...
Source: `e2e-next/e2e_suite_test.go`

Register `DeferCleanup` for rendered YAML files in `SynchronizedBeforeSuite`, before cluster setup begins. This ensures cleanup runs even if setup fails partway through.
...
var _ = SynchronizedBeforeSuite(
    func(ctx context.Context) (context.Context, []byte) {
        ...
        // Clean up vcluster yaml — registered before setup so they run even on failure
