...
One defines hooks as part of the [generic sync configuration](../architecture/synced-resources#configuration-syntax) in the hooks field.
...
The `patches` reuse the same [syntax as the patches](../architecture/synced-resources#patch-syntax) utilized in [generic sync](../architecture/synced-resources#generic-sync).
