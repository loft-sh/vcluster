...
To bypass this, the feature + component called Central Hostpath Mapper has been extended.

This is a loft integrated feature and the related docs can be found [here](https://loft.sh/docs/virtual-clusters/central-hostpath-mapper). Or you can follow the instructions below:
