...
You can deploy your plugin to a vcluster using the same commands as [described on the overview page](./plugins-overview#loading-and-installing-plugins-to-vcluster), for example, with the vcluster CLI.
```
