...
# Install a plugin with helm with remote url
...
:::info Examples
You can take a look at the [vcluster-sdk](https://github.com/loft-sh/vcluster-sdk/tree/main/examples) for some working examples
:::
