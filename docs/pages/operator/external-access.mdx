...
To use an [Ingress Controller](https://kubernetes.io/docs/concepts/services-networking/ingress-controllers/) , check first their documentation to see if SSL Passthrough is supported. Some popular ingress providers that have this feature are:
...
- [AWS ALB](https://docs.giantswarm.io/advanced/ingress/configuration/#ssl-passthrough)
