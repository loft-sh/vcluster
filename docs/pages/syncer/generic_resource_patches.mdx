...
The `patches` reuse the same [syntax as the patches](./other_resources/config_syntax.mdx#patch-syntax) utilized in [generic sync](./other_resources/generic_sync.mdx).
