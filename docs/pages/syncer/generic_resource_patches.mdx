...
One defines hooks as part of the [generic sync configuration](/docs/syncer/other_resources/config_syntax) in the hooks field.
...
The `patches` reuse the same [syntax as the patches](/syncer/other_resources/config_syntax#patch-syntax) utilized in [generic sync](/docs/syncer/other_resources/generic_sync).
