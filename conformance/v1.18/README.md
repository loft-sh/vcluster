...
# At the time of writing 1.18.17 was latest in
# stable channel
export CLUSTER_VERSION=1.18.17-gke.1901
export CLUSTER_CHANNEL=stable
...
```yaml
vcluster:
  image: rancher/k3s:v1.18.17-k3s1
...
export CONFORMANCE_VERSION=v1.18.17
